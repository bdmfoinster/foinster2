  ...
  return (
    <html lang="en">
      <body className={`${geist.variable} ${geist.variable} font-body antialiased`}>
        ...
        <Footer />
        <a 
          href="https://wa.me/917560870124" 
          target="_blank" 
          rel="noreferrer"
          className="fixed bottom-6 right-6 z-[9999] w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-300 hover:shadow-xl"
